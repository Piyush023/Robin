...
import { RFValue } from 'react-native-responsive-fontsize'; // TODO - Need to Learn About This.
...
interface Props {
  ...
  onLayout?: (event: object) => void; // Todo - What is This.
}
...
const CustomText: React.FC<Props> = ({
  ...
  const { colors } = useTheme(); // * Important - This is used to get the current Theme of the Device - Light or Dark
